...
exports.authUserLinkedinCallback = exports.authUserLinkedin = exports.authUserGithubCallback = exports.authUserGithub = exports.authUserGoogleCallback = exports.authUserGoogle = exports.checkAuthUser = exports.unAuthUser = exports.authUser = undefined;
 ...
 *     }
 */
let authUser = exports.authUser = (() => {
  var _ref = _asyncToGenerator(function* (ctx, next) {
    return _koaPassport2.default.authenticate('local', function (user) {
      updateCtx(ctx, user, { user });
    })(ctx, next);
  });

  return function authUser(_x, _x2) {
